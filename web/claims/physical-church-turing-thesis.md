...
The claim that nature has no computer more powerful than an ordinary one: anything any physical
process can compute, a standard computer could too (given enough time and memory). If that's right,
