...
headword: Dancing-qualia presupposes introspection
author: mishka
status: asserted
...
scope: A diagnostic claim about the reductio's hidden premise. It does NOT assert that dancing qualia
are actual, nor that introspection is non-functional; it asserts that the reductio's force *depends on*
an assumption the residue theorist is entitled to reject. Corollary: the residue theorist may instead
take introspection to be an acquaintance relation, on which experience and introspective judgement move
together (no self-deception) or, where the construction forcibly fixes a judgement-disposition without
acquaintance, the resulting "self-deception" is a built malfunction, not an absurd metaphysical
commitment.

who would deny it: functionalists who hold introspective judgement is independently and obviously a
