...
functionalism. An organisational-role functionalist (mu-043) grants that it lacks mind and excludes
...
table. mu-043 denies exactly this: an LLM is not a flat query→answer map but has rich internal
...
Distinct from argument-role-grain-dilemma and argument-dense-china-brain-regress (both alvin): those
