...
commits_to: [claim-consciousness-noncomputable]
...
Penrose argues that human insight — especially the way mathematicians can *see* a truth no fixed
rulebook could grind out — shows the mind is doing something no computer program can do. His
conclusion: consciousness must tap physics that isn't computable, which he locates in tiny
quantum-collapse events inside brain cells (the "Orch-OR" theory, with Hameroff). The upshot for AI:
